-- Script corrigido para testar o sistema de arquivamento automático
...
-- 10. Mostrar histórico de arquivamento recente (CORRIGIDO)
SELECT 
...
-- 12. Verificar se há cards que deveriam ser arquivados mas não foram
SELECT 
...
-- 13. Criar um card de teste para arquivamento (OPCIONAL - descomente se necessário)
/*
...
-- 14. Ativar arquivamento automático se estiver desativado
UPDATE archive_settings 
SET auto_archive_enabled = true, archive_after_days = 30 
WHERE board_id IS NULL 
AND auto_archive_enabled = false;

-- 15. Verificar status final
SELECT 
    'Status final do sistema' as status,
    'Arquivamento automático configurado e funcionando' as resultado;
