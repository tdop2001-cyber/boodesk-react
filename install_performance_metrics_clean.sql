-- =====================================================
-- INSTALAÇÃO LIMPA DO SISTEMA DE MÉTRICAS DE PERFORMANCE
-- =====================================================
...
BEGIN
    ...
    SELECT COUNT(*) INTO v_result FROM get_monthly_report(NULL::TEXT);
    RAISE NOTICE 'Relatório mensal: % métricas geradas', v_result.count;
