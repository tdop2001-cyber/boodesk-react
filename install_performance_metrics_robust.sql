-- =====================================================
-- INSTALAÇÃO ROBUSTA DO SISTEMA DE MÉTRICAS DE PERFORMANCE
-- =====================================================

-- Este script remove TODAS as funções existentes e instala o sistema completo
-- Execute este script no Supabase SQL Editor

-- 1. REMOVER TODAS AS FUNÇÕES EXISTENTES (TODAS AS ASSINATURAS)
DO $$
DECLARE
    func_record RECORD;
BEGIN
    -- Remover todas as funções de métricas existentes (todas as assinaturas)
    FOR func_record IN 
